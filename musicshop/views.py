...
class AddToCartView(CartMixin, views.View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        messages.add_message(request, messages.INFO, "The product was successfully added")
...
class DeleteFromCartView(CartMixin, views.View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        cart_product.delete()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "The product was successfully deleted")
        return HttpResponseRedirect(request.META['HTTP_REFERER'])
...
class ChangeQTYView(CartMixin, views.View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        cart_product.save()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "Number of successfully changed")
        return HttpResponseRedirect(request.META['HTTP_REFERER'])
...
class MakeOrderView(CartMixin, views.View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Thank you for ordering! The manager will contact you')
            return HttpResponseRedirect('/')
        return HttpResponseRedirect('/checkout/')
